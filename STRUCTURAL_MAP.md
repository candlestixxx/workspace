...
| realestatecrm | realestatecrm/ | git@github.com:candlestixxx/realestatecrm.git | b5ea46ad68af4718121bd552a86d6d15acb9f228 |
...
**Note:** All submodules are original candlestixxx repos (not forks of robertpelloni). `ultratrader` was forked from robertpelloni/ultratrader (upstream no longer accessible, dead remote removed). `warp` and `xrnet` removed — their GitHub repos were deleted during fork cleanup.

Root remote: `https://github.com/candlestixxx/workspace.git` (main branch)

**Last verified:** 2026-06-26 (v1.0.7) — Re-synchronized and branch reconciled (15 total). All submodules fetched, tracked, and reconciled.
